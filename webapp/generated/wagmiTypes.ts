// Generated by @wagmi/cli@0.1.5 on 3/25/2023 at 12:10:14 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link basicFevmDalnABI}__ and `functionName` set to `"ADMIN_ROLE"`.
 */
export function useBasicFevmDalnAdminRole(
  config: Omit<
    UseContractReadConfig<typeof basicFevmDalnABI, 'ADMIN_ROLE'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof basicFevmDalnABI, 'ADMIN_ROLE'>)
}
