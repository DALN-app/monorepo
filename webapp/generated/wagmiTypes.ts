// Generated by @wagmi/cli@0.1.5 on 4/24/2023 at 1:16:25 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link basicFevmDalnABI}__ and `functionName` set to `"USER_ROLE"`.
 */
export function useBasicFevmDalnUserRole(
  config: Omit<
    UseContractReadConfig<typeof basicFevmDalnABI, 'USER_ROLE'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return useContractRead({
    ...
    ...config,
  } as UseContractReadConfig<typeof basicFevmDalnABI, 'USER_ROLE'>)
}
